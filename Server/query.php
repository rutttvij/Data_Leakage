...
CREATE TABLE IF NOT EXISTS data_files(
    ...
    time_of_transfer DATETIME DEFAULT NULL,
    time_of_download DATETIME DEFAULT NULL  
)");

define('KEY_REQUEST_TABLE_QUERY', "
CREATE TABLE IF NOT EXISTS key_requests(
    ...
    time_of_request DATETIME DEFAULT NULL  
)");
...
define('LEAKER_TABLE_QUERY', "CREATE TABLE IF NOT EXISTS leakers (
    ...
    secret_key VARCHAR(255) NOT NULL,
    leaked_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP
)");
